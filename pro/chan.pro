PRO CHAN,IPLANE,xsize,ysize, PLOT=plot,FREE = free
;+
; NAME:
;	CHAN
; PURPOSE:
...
if size(ysize,/type) eq 0 then ysize=410
if size(xsize,/type) eq 0 then ysize=512

 IF keyword_set(plot) then begin
             window, iplane, xsize=xsize,ysize=ysize, $ 
